...
class App extends React.Component {
  ...
  //   this.setState({
  //     utilisateur: this.state.utilisateur.map((user) =>
      ...
      <>
        <Container fluid style={{ marginTop: "2rem", fontSize: "1rem" }}>
          <Row>
            ...
            <h4 style={{ backgroundColor: "grenn" }}>
              Display Edit and Delete users
            </h4>

            <Col style={{ backgroundColor: "#aaa" }}>
              <Display deleteUser={this.deleteUser} editUser={this.editUser} />
            </Col>
          </Row>
        </Container>
      </>
